...
OBJECTS += MC-Pad_rev1.8.o
 ...
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F446RE/TOOLCHAIN_GCC_ARM/except.o
 ...
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F446RE/TOOLCHAIN_GCC_ARM/mbed_fault_handler.o
 ...
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F446RE/TOOLCHAIN_GCC_ARM/qspi_api.o
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1661045604.488196
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1661045604.488196
...
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/f/f0625e1c829ef8fe5b18875e3b0ad7bf/MC-Pad/mbed_config.h
ASM_FLAGS += -c
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -Wall
